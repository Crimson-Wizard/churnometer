...
def page_cluster_body():
    ...
    cluster_silhouette = plt.imread(
        f"jupyter_notebooks/outputs/ml_pipeline/cluster_analysis/{version}/clusters_silhouette.png")
    features_to_cluster = plt.imread(
        f"jupyter_notebooks/outputs/ml_pipeline/cluster_analysis/{version}/features_define_cluster.png")
